...
def Story1(debug = False):
    ...
    out = "\n"
    out += "One day me and my friend " + friendName1 + " were out playing " + sport1
    out += " Then we saw our neighbor " + neighborName1 + " and they decided to come play with us "
    out += "we all just happened to live in " + State1 + " and we were the best of friends "
